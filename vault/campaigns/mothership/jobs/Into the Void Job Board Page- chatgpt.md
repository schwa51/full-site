...
### Primary Objectives
- Locate and secure the **Final Report** from the Oculus research database.  
...
- Recover biological or data samples for MeirTech’s R&D division.  
- Evaluate the performance of the new **protective hull polymer** under radiation stress.  
- Avoid public disclosure of internal malfunctions or casualties.
...
### Equipment & Support
- Access codes for the Oculus docking bay.  
- Clearance to operate under MeirTech salvage and reclamation authority.  
- Optional assignment of an internal security observer (Chastain liaison).
